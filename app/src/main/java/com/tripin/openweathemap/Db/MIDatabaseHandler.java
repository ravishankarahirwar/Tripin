package com.tripin.openweathemap.Db;
...
public class MIDatabaseHandler extends SQLiteOpenHelper {
    ...
    private void createTableSearch(SQLiteDatabase db) {
        ...
        hashtable.put(DbParam.CityID, "VARCHAR");

        createTable(db, DbParam.Table_Search, hashtable);
    ...
    public void editData(Hashtable<String, String> queryValues, String Key,
        ...
        try {
            ...
            int result = database.update(TABLE_NAME, values, Key + "=" + value,
                    null);
    ...
    public int editDatawithresult(Hashtable<String, String> queryValues, String Key,
        ...
        try {
            ...
            result = database.update(TABLE_NAME, values, Key + "=" + value,
                    null);
